...
public class EntityAirplaneTMob
extends EntityAirplaneT {
    ...
    public void initAttrs(IShipAttackBase host, Entity target, int scaleLevel, float ... par2) {
        ...
        if (host instanceof BasicEntityShipHostile) {
            ...
            this.shipAttrs.setAttrsBuffed(0, ship.getMaxHealth() * 0.09f);
            ...
            this.shipAttrs.setAttrsBuffed(7, ship.getAttrs().getMoveSpeed() * 0.1f + 0.2f + this.getScaleLevel() * 0.05f);
