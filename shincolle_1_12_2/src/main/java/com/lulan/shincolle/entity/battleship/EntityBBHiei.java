...
public class EntityBBHiei extends BasicEntityShipSmall {
    ...
    private static final int ATTACK_EFFECT_KEY_BATTLE_AURA = 19;
    ...
    private void applyBuffToNearbyAllies() {
        ...
        nearbyShips.stream()
                ...
                .forEach(ship -> ship.addPotionEffect(new PotionEffect(MobEffects.SATURATION, 100 + this.getStateMinor(0) * 2, this.getStateMinor(0) / 120, false, false)));
    }

    @Override
    public void calcShipAttributesAddEffect() {
        super.calcShipAttributesAddEffect();
        this.AttackEffectMap.put(ATTACK_EFFECT_KEY_BATTLE_AURA, new int[]{this.getLevel() / 85, 80 + this.getLevel(), this.getLevel()});
    }
