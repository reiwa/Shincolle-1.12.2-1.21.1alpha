...
public class EntityBBKirishima extends BasicEntityShipSmall {
    ...
    private static final int ATTACK_EFFECT_KEY_MIC_CHECK = 15;
    ...
    private void applyBuffToNearbyAllies() {
        ...
        nearbyShips.stream()
                ...
                .forEach(ship -> ship.addPotionEffect(new PotionEffect(MobEffects.NIGHT_VISION, 100 + this.getStateMinor(0), 0, false, false)));
    }

    @Override
    public void calcShipAttributesAddEffect() {
        super.calcShipAttributesAddEffect();
        this.AttackEffectMap.put(ATTACK_EFFECT_KEY_MIC_CHECK, new int[]{0, 50 + this.getLevel(), this.getLevel()});
    }
